...
namespace ABPS.Aiml.Utils 
{
    ...
    { 
        ...
        public AIMLTagHandler   (   ABPS.Aiml.Bot bot, 
                                    ABPS.Aiml.User user, 
