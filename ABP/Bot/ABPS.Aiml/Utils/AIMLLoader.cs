...
namespace ABPS.Aiml.Utils
{
    ...
    public class AIMLLoader
    {
        ...
        public AIMLLoader(ABPS.Aiml.Bot bot)
        {
            this.bot = bot;
        }
        ...
        public string Normalize(string input, bool isUserInput)
        {
            ...
            Normalize.ApplySubstitutions substitutor = new ABPS.Aiml.Normalize.ApplySubstitutions(this.bot);
            Normalize.StripIllegalCharacters stripper = new ABPS.Aiml.Normalize.StripIllegalCharacters(this.bot);
