...
namespace ABPS.Aiml
{
    ...
    public class Bot
    {
        ...
        /// </summary>
        public ABPS.Aiml.Utils.Node Graphmaster;
        ...
        private void setup()
        {
            ...
            this.Graphmaster = new ABPS.Aiml.Utils.Node(); 
        }
        ...
        public void loadSettings(string pathToSettings)
        {
            ...
            {
                this.GlobalSettings.addSetting("website", "http://sourceforge.net/projects/ABPS.Aiml");
            }
        ...
        public Result Chat(Request request)
        {
            ...
            if (this.isAcceptingUserInput)
            {
                // Normalize the input
                AIMLLoader loader = new AIMLLoader(this);
                ABPS.Aiml.Normalize.SplitIntoSentences splitter = new ABPS.Aiml.Normalize.SplitIntoSentences(this);
        ...
        {
            MailMessage msg = new MailMessage("donotreply@ABPS.Aiml.com",this.AdminEmail);
            msg.Subject = "WARNING! ABPS.Aiml has encountered a problem...";
