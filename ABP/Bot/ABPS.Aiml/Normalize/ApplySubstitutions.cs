...
namespace ABPS.Aiml.Normalize
{
    ...
    /// </summary>
    public class ApplySubstitutions : ABPS.Aiml.Utils.TextTransformer
    {
        public ApplySubstitutions(ABPS.Aiml.Bot bot, string inputString)
            : base(bot, inputString)
        { }

        public ApplySubstitutions(ABPS.Aiml.Bot bot)
            : base(bot)
        { }
        ...
        public static string Substitute(ABPS.Aiml.Bot bot, ABPS.Aiml.Utils.SettingsDictionary dictionary, string target)
        {
