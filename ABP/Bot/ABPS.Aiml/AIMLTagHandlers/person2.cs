...
namespace ABPS.Aiml.AIMLTagHandlers
{
    ...
    /// </summary>
    public class person2 : ABPS.Aiml.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public person2(ABPS.Aiml.Bot bot,
                        ABPS.Aiml.User user,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "person2")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return ABPS.Aiml.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.Person2Substitutions, this.templateNode.InnerText);
                }
                else
                {
