...
namespace ABPS.Aiml.AIMLTagHandlers
{
    ...
    /// </summary>
    public class person : ABPS.Aiml.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public person(ABPS.Aiml.Bot bot,
                        ABPS.Aiml.User user,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "person")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return ABPS.Aiml.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.PersonSubstitutions, this.templateNode.InnerText);
                }
                else
                {
