...
namespace ABPS.Aiml.AIMLTagHandlers
{
    ...
    /// </summary>
    public class gender : ABPS.Aiml.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public gender(ABPS.Aiml.Bot bot,
                        ABPS.Aiml.User user,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "gender")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return ABPS.Aiml.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.GenderSubstitutions, this.templateNode.InnerText);
                }
                else
                {
