...
namespace ABPS.Aiml.AIMLTagHandlers
{
    ...
    /// </summary>
    public class sr : ABPS.Aiml.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "sr")
            {
                ...
                XmlNode sraiNode = ABPS.Aiml.Utils.AIMLTagHandler.getNode("<srai>"+starContent+"</srai>");
