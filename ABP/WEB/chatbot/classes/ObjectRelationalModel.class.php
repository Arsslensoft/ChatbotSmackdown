...
abstract class ObjectRelationalModel extends SerializableModel
{
     ...
     * @return mixed
     */
    public static function sql ($sql, $return = ObjectRelationalModel::FETCH_MANY)
    {
        // shortcuts
        ...
        if ($return === ObjectRelationalModel::FETCH_NONE)
            return;
        ...
        if ($return === ObjectRelationalModel::FETCH_ONE)
    ...
    {
        $count = self::sql($sql, ObjectRelationalModel::FETCH_ONE);
    ...
    {
        self::sql('TRUNCATE :database.:table', ObjectRelationalModel::FETCH_NONE);
    }
    ...
    public static function retrieveByPK ($pk)
    {
        ...
        return $reflectionObj->newInstanceArgs(array($pk, ObjectRelationalModel::LOAD_BY_PK));
    }
    ...
    public static function hydrate ($data)
    {
        ...
        return $reflectionObj->newInstanceArgs(array($data, ObjectRelationalModel::LOAD_BY_ARRAY));
    }
     ...
     * @return mixed
     */
    public static function retrieveByField ($field, $value, $return = ObjectRelationalModel::FETCH_MANY)
    {
        if (!is_string($field))
